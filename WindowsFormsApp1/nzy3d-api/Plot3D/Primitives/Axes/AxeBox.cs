	...
	public class AxeBox : IAxe
	{
		...
		public void Draw(Rendering.View.Camera camera)
		{
			...
			if (_layout.FaceDisplayed) {
				...
				// handle stippling
				drawCube(OpenTK.Graphics.ES11.RenderingMode.Render);
		...
		/// </summary> 
		public void drawCube(OpenTK.Graphics.ES11.RenderingMode mode)
		{
			for (int q = 0; q <= 5; q++) {
				if (mode == OpenTK.Graphics.ES11.RenderingMode.Feedback) {
					GL.PassThrough(q);
				}
